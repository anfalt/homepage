...
if (!class_exists('Understrap_WP_Bootstrap_Navwalker')) {
	...
	class Understrap_WP_Bootstrap_Navwalker extends Walker_Nav_Menu
	{
		...
		public function start_lvl(&$output, $depth = 0, $args = array())
		{
			...
			$classes = array('dropdown-menu-flyout');
			/**
		...
		public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
		{
			...
			if (isset($args->has_children) && $args->has_children && 0 === $depth && $args->depth !== 1) {
				...
				if ($depth > 0) {
					$atts['class'] = 'dropdown-flyout-item';
				} else {
					$atts['class'] = 'nav-link';
				}
			}
			...
			if ($depth > 0 && isset($args->link_after_isChild)) {
				$item_output .= $args->link_after_isChild ?: '';
			}

			if (isset($args->link_after_hasChildren) && $args->has_children  && isset($args->link_after_hasChildren)) {
				$item_output .= $args->link_after_hasChildren ?: '';
			}
